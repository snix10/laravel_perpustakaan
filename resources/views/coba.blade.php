...
<body>
    ...
    <div class="swal2-container swal2-center swal2-backdrop-show" style="overflow-y: auto;">
        <div aria-labelledby="swal2-title" aria-describedby="swal2-html-container"
            ...
            <h2 class="swal2-title" id="swal2-title" style="display: block;">Enter your IP address</h2>
            <div class="swal2-html-container" id="swal2-html-container" style="display: none;"></div><label
                for="swal2-input" class="swal2-input-label">Your IP address</label><input id="swal2-input"
                class="swal2-input form-control" placeholder="" type="text" style="display: flex;"><input
            ...
            <div class="swal2-actions" style="display: flex;">
                <div class="swal2-loader"></div><button type="button" class="swal2-confirm swal2-styled"
                    aria-label="" style="display: inline-block;">OK cobaaa</button><button type="button"
